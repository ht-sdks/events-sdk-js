...
describe('buildPayLoad_function', () => {
  ...
  it('test_default_pii_properties', () => {
    ...
    expect(buildPayLoad(htElement, whitelistPiiPropertiesMock, blacklistPiiPropertiesMock)).toEqual(
      expectedPayload,
    );
  });
  ...
  it('test_empty_blacklist_pii_whitelist_pii_properties', () => {
    ...
    expect(
      buildPayLoad(htElement, emptyblacklistPiiPropertiesMock, emptywhitelistPiiPropertiesMock),
  ...
  it('test_empty_payload', () => {
    ...
    const result = buildPayLoad(htElement, whitelistPiiPropertiesMock, blacklistPiiPropertiesMock);
  ...
  it('test_pii_properties_in_blacklist_excluded_or_hashed', () => {
    ...
    const payload = buildPayLoad(htElement, whitelistPiiPropertiesMock, blacklistPiiPropertiesMock);
  ...
  it('if_integrationobj_contains_hash_true_for_pii_blacklist', () => {
    ...
    const payload = buildPayLoad(
      ...
      getHashedStatus(htElement.message, 'fbpixel'),
    );
    expect(payload).toEqual({
      lastName: 'Doe',
    });
